        ...
        <div className="grid md:grid-cols-[48%_52%]">
          ...
          <div className="flex flex-col justify-between px-8 py-6 lg:px-10">
            <div>
              ...
              <button
                type="button"
                className="mt-4 flex w-full items-center justify-center gap-3 rounded-xl border border-zinc-300 bg-white px-4 py-2.5 text-sm font-medium text-zinc-700 transition hover:bg-zinc-50"
              >
